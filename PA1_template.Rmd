...
par(mfrow=c(2,1))
#weekdays
xwd<-as.numeric(as.character(StepsWeekdays$interval))
ywd<-as.numeric(as.character(StepsWeekdays$steps))
plot(xwd, ywd, type="l", col = "red", xlab = "Interval Weekdays", ylab = "Average Steps")
# weekends
xwe<-as.numeric(as.character(StepsWeekend$interval))
ywe<-as.numeric(as.character(StepsWeekend$steps))
plot(xwe, ywe, type="l", col = "red", xlab = "Interval Weekends", ylab = "Average Steps")
...
myw<-rbind(wd,we)
plot(myw$interval, myw$steps, type = "l")
